...
import { ArrowRight, Download, Zap, ShieldCheck, CheckCircle2 } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            ...
            >
              ...
              <strong className="text-slate-900 font-bold">80% hoa hồng ròng</strong> từ đơn đủ điều kiện trực tiếp vào ví ngân hàng.
            </motion.p>
            ...
            >
              <Link
                href="#download"
                className="btn-primary text-white font-bold text-sm sm:text-base px-7 py-3.5 rounded-2xl flex items-center justify-center gap-2.5 shadow-xl shadow-blue-500/25 w-full sm:w-auto"
              >
            ...
            >
              ...
              <div className="flex items-center gap-1.5">
                <CheckCircle2 className="w-4 h-4 text-emerald-500" />
                <span>Theo dõi đơn rõ ràng</span>
              </div>
              <span className="text-slate-300 hidden sm:inline">•</span>
              <div className="flex items-center gap-1.5">
                <CheckCircle2 className="w-4 h-4 text-emerald-500" />
                <span>Rút về mọi ngân hàng</span>
              </div>
            </motion.div>
          </div>

          {/* Right Column: Premium Phone Presentation with Floating Cards */}
          <motion.div
          ...
          >
            <div className="relative">
              {/* Phone Mockup with Real Home Screen */}
              <PhoneMockup imageSrc="/assets/screen-home.png" alt="Giao diện LinkP Trang chủ" />
